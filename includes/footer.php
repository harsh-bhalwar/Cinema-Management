...
<div class="footer-section footer-section2">
    ...
    <div class="footer-section-inner-container">
        ...
        <span><a href="https://twitter.com/HarshBhalwar" target="_blank" ><i class="fab fa-lg fa-twitter-square"></i> Twitter</a></span>
        <span><i class="fab fa-lg fa-instagram"></i> Instagram</span>
    </div>
</div>
<div class="footer-section  footer-section3">
    <p>© 2024 ARVR Movies. Created by Harsh Bhalwar And Dhruv Khandelwal </p>
    <a>Advertising</a>
    <a>Privacy Policy</a>

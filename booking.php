            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="12-3">April 24, 2024</option>
                        <option value="13-3">April 25, 2024</option>
                        <option value="14-3">April 26, 2024</option>
                        <option value="15-3">April 27, 2024</option>
                        <option value="16-3">April 28, 2024</option>
                    </select>

    ...
    <div id="home-section-3" class="trailers-section">
        ...
        <div class="trailers-grid">
            <div class="trailers-grid-item">
                <img src="img/dark.avif" alt="Dark">
                <div class="trailer-item-info" data-video="cq2iTHoLrt0">
                    <h3>Dark</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/endgame.png" alt="Avengers Endgame">
            ...
            <div class="trailers-grid-item">
                <img src="img/interstellar.jpeg" alt="Interstellar">
            ...
            <div class="trailers-grid-item">
                <img src="img/oppenheimer.jpeg" alt="Oppenheimer">
                <div class="trailer-item-info" data-video="uYPbbksJxIg">
                    <h3>Oppenheimer</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/strangerThings.jpeg" alt="Stranger Things">
                <div class="trailer-item-info" data-video="sBEvEcpnG7k">
                    <h3>Stranger Things</h3>
                    <i class="far fa-3x fa-play-circle"></i>
                </div>
            </div>
            <div class="trailers-grid-item">
                <img src="img/venom.jpeg" alt="Venom">
